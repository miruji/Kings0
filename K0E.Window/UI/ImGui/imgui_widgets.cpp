...
static bool InputTextFilterCharacter(unsigned int* p_char, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback, void* user_data, ImGuiInputSource input_source)
{
    ...
    if (flags & (ImGuiInputTextFlags_OnlyNumbers | ImGuiInputTextFlags_CharsDecimal | ImGuiInputTextFlags_CharsHexadecimal | ImGuiInputTextFlags_CharsUppercase | ImGuiInputTextFlags_CharsNoBlank | ImGuiInputTextFlags_CharsScientific))
    {
        ...
        // Allow 0-9
        if (flags & ImGuiInputTextFlags_OnlyNumbers)
...
bool ImGui::InputTextEx(const char* label, const char* hint, char* buf, int buf_size, const ImVec2& size_arg, ImGuiInputTextFlags flags, ImGuiInputTextCallback callback, void* callback_user_data)
{
    ...
    bool is_multiline = (flags & ImGuiInputTextFlags_Multiline & !ImGuiInputTextFlags_NoMultiline) != 0;
    ...
    if (is_multiline)
    {
        if(!BeginChildFrame(id, frame_bb.GetSize(), ImGuiWindowFlags_AlwaysVerticalScrollbar))
        {
            ItemSize(total_bb, style.FramePadding.y);
            EndGroup();
            return false;
