...
enum ImGuiInputTextFlags_
{
    ...
    ImGuiInputTextFlags_OnlyNumbers         = 1 << 20,  // KINGS0 to connect input type [ONLY NUMBERS]
    ImGuiInputTextFlags_NoMultiline         = 1 << 21   // Kings0 to connect input type [NO MULTILINE]
